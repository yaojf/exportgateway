...
import com.yaojiafeng.exportgateway.biz.invoke.annotation.AnnotaionBeanFinder;
...
public class CustomInvokeMapping extends AbstractInvokeMapping {
    ...
    private MethodInfo createMethodInfo(AnnotatedElement element) {
        com.yaojiafeng.exportgateway.biz.invoke.annotation.Method method = AnnotationUtils.findAnnotation(element, com.yaojiafeng.exportgateway.biz.invoke.annotation.Method.class);
        if (method != null) {
